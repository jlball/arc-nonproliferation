...
for mass in masses:
    ...
    U_device.deplete(time_steps, source_rates=source_rates, operator_kwargs={'chain_file':'chain_endfb71_pwr.xml', 'normalization_mode':'source-rate'}) #, integrator_kwargs={'source_rates':source_rates}
    Th_device.deplete(time_steps, source_rates=source_rates, operator_kwargs={'chain_file':'chain_endfb71_pwr.xml', 'normalization_mode':'source-rate'})